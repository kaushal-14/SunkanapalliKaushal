                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                   ...
                                   <form method="post" enctype="multipart/form-data">
                                    <p>In this panel you can add Images to your Website</p>
                                      
                                        <label id=s1>Select an image:</label>
                                        <input type="file" name="image"/>
                                        <input type="text" name="titlee" id="s1" placeholder="Enter the Title" />
                                        <textarea id="s2" name="des" placeholder="Enter the Description"></textarea>
